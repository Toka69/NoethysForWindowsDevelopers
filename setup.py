...
setup(
    ...
    author = "Ivan LUCAS",
    description = u"Noethys, le logiciel libre et gratuit de gestion multi-activit�s",
...
if "py2exe" in sys.argv :
    ...
    # IMPORTANT : Ce code ne fonctione que si Pytz est unzipp� :
    # Commande easy_install --upgrade --always-unzip pytz
    # Pour la mettre � jour avec un d�zippe automatique
    ...
    # Importe le cacert.pem dans le r�pertoire certifi
    import certifi
    ...
    # Supprime le r�pertoire des donn�es exemples de Matplotlib
